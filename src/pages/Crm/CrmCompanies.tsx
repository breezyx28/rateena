...
const CrmCompanies = () => {
  ...
  const crmcompaniesData = createSelector(selectLayoutState, (state: any) => ({
    companies: state.companies,
    isCompaniesSuccess: state.isCompaniesSuccess,
    error: state.error,
  }));
  // Inside your component
  const { companies, error } = useSelector(crmcompaniesData);
  ...
  document.title = "Companies | Rateena - E-Shop Admin Panel";
  return (
    <React.Fragment>
                  ...
                  <div className="d-flex align-items-center flex-wrap gap-2">
                    ...
                    <div className="flex-shrink-0">
                      <div className="hstack text-nowrap gap-2">
                        ...
                        <button className="btn btn-secondary material-shadow-none">
                        ...
                        <UncontrolledDropdown>
                          <DropdownToggle
                            href="#"
                            className="btn btn-soft-info btn-icon material-shadow-none"
                            tag="button"
                          >
