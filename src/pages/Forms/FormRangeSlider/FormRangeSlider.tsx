...
const FormRangeSlider = () => {
  ...
  document.title = "Range Slider | Rateena - E-Shop Admin Panel";
                    ...
                    <div>
                      <div>
                        ...
                        <p className="text-muted">
                          Use <code>form-range</code> class to create a default
                          range.
                        </p>
                      ...
                      <div className="mt-4">
                        ...
                        <p className="text-muted">
                          Use <code>disabled</code> attribute on an input to
                          give it a grayed out appearance and remove pointer
                          events.
                        </p>
                      ...
                      <div className="mt-4">
                        ...
                        <p className="text-muted">
                          Use <code>min</code> and <code>max</code> attribute
                          with specified range input respectively.
                        </p>
                      ...
                      <div className="mt-4">
                        ...
                        <p className="text-muted">
                          ...
                          change this, you can specify a step value. In the
                          example below, we double the number of steps by using{" "}
                          <code>step="0.5"</code> attribute.
                        </p>
                  ...
                  <Row className="mt-4">
                    <Col xl={4} lg={6}>
                      <div className="mt-4">
                        ...
                        <p className="text-muted mb-4">
                          Use{" "}
                          <code>
                            data-rangeslider data-slider-color=&quot;info&quot;
                          </code>{" "}
                    ...
                    <Col xl={4} lg={6}>
                      <div className="mt-4">
                        ...
                        <p className="text-muted mb-4">
                          Use <code>data-slider-color=&quot;warning&quot;</code>{" "}
                    ...
                    <Col xl={4} lg={6}>
                      <div className="mt-4">
                        ...
                        <p className="text-muted mb-4">
                          Use{" "}
                          <code>
                            data-rangeslider data-slider-color=&quot;dark&quot;
                          </code>{" "}
