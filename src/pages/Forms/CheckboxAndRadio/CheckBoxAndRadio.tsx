...
const CheckBoxAndRadio = () => {
  document.title = "Checkbox & Radio | Rateena - E-Shop Admin Panel";
  return (
    <React.Fragment>
      <UiContent />
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <div className="hstack gap-2 flex-wrap">
                      ...
                      />
                      <Label
                        className="btn btn-outline-primary material-shadow"
                      ...
                      />
                      <Label
                        className="btn btn-outline-secondary material-shadow"
                      ...
                      />
                      <Label
                        className="btn btn-outline-success material-shadow"
