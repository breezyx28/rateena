...
const BasicElements = () => {
  document.title = "Basic Elements | Rateena - E-Shop Admin Panel";
                        ...
                        <div>
                          <FormGroup floating>
                            <Input
                              ...
                              type="text"
                            />
                            <Label for="exampleEmail">Floating Input</Label>
                          </FormGroup>
                        </div>
                      </Col>
                    </Row>
                      ...
                      <Row className="g-3">
                        ...
                        <Col lg={12}>
                          <UncontrolledDropdown className="input-group">
                            <DropdownToggle
                              tag="button"
                              className="btn btn-outline-secondary dropdown-toggle material-shadow-none"
                              type="button"
                              data-bs-toggle="dropdown"
                              aria-expanded="false"
                            >
