...
const CoverSignUp = () => {
  document.title = "Cover SignUp | Rateena - E-Shop Admin Panel";
                      ...
                      <div className="p-lg-5 p-4">
                        <div>
                          ...
                          <p className="text-muted">
                            Get your Free Rateena account now.
                          </p>
                        </div>
                          ...
                          >
                            ...
                            <div className="mb-4">
                              <p className="mb-0 fs-12 text-muted fst-italic">
                                By registering you agree to the Rateena{" "}
                                <Link
                                  to="#"
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="text-center">
                  <p className="mb-0">
                    {new Date().getFullYear()} Rateena. Crafted with{" "}
