...
const LiveAuction = () => {
  document.title = "Live Auction | Rateena - E-Shop Admin Panel";
              ...
              <Row>
                <Col lg={12}>
                  <div className="text-center mb-3">
                    <button className="btn btn-link text-success mt-2 material-shadow-none">
                            ...
                            <td>
                              <div className="d-flex align-items-center">
                                <img
                                  src={item.img}
                                  alt=""
                                  className="avatar-sm object-fit-cover rounded-circle"
                                />
                                <div className="ms-2">
                                  <Link to="/apps-nft-item-details">
