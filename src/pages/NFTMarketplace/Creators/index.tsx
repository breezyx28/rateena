...
const Creators = () => {
  document.title = "Creators | Rateena - E-Shop Admin Panel";
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          ...
          <Row>
            <Col lg={12}>
              <h5 className="card-title mb-4 fw-semibold fs-16">
                Creators Grid Lists
              </h5>
            </Col>
          </Row>
                ...
                <Card>
                  ...
                  <div className="card-body text-center">
                    <img
                      src={item.img}
                      alt=""
                      className="avatar-md rounded-circle object-fit-cover mt-n5 img-thumbnail border-light mx-auto d-block"
                    />
                    <Link to="/pages-profile">
