...
const Ranking = () => {
  document.title = "Ranking | Rateena - E-Shop Admin Panel";
    ...
    () => [
      {
        ...
        cell: (cell: any) => {
          if (cell.getValue() < 4) {
            return (
              <div className="ranking text-info fw-semibold">
                #{cell.getValue()}
              </div>
            );
          } else {
            ...
            <div className="collection">
              <div className="d-flex align-items-center">
                <img
                  ...
                  alt=""
                  className="avatar-xs rounded-circle object-fit-cover me-2"
                />{" "}
                <Link to="/apps-nft-item-details" className="text-body">
                  {cell.getValue()}
                </Link>
              </div>
            </div>
      ...
      },
      {
        ...
        cell: (cell: any) => {
          if (cell.getValue() > 0) {
            return (
              <h6 className="text-success mb-1 24h"> {cell.getValue()} ETH</h6>
            );
          } else {
            return (
              <h6 className="text-danger mb-1 24h">{cell.getValue()} ETH</h6>
            );
          }
        },
      },
      {
        ...
        cell: (cell: any) => {
          if (cell.getValue() > 0) {
            return (
              <h6 className="text-success mb-1 7d"> {cell.getValue()} ETH</h6>
            );
          } else {
            return (
              <h6 className="text-danger mb-1 7d">{cell.getValue()} ETH</h6>
            );
          }
        },
      },
                ...
                <div className="card-header border-0">
                  <div className="d-flex align-items center">
                    <h5 className="card-title mb-0 flex-grow-1">
                      The top NFTs ranking on Rateena
                    </h5>
