...
const ItemDetails = () => {
  document.title = "Item Details | Rateena - E-Shop Admin Panel";
              ...
              <Row className="g-4">
                      ...
                      <div className="position-absolute bottom-0 p-3">
                        ...
                        <Row className="justify-content-center">
                          ...
                          <Col className="col-3">
                            <img
                              src={
                                "https://img.themesbrand.com/velzon/images/img-3.gif"
                              }
                              alt=""
                ...
                <Col lg={8}>
                  <div>
                    ...
                    <span className="badge bg-info-subtle  text-info mb-3 fs-12">
                                ...
                                <tr>
                                  <th scope="row">
                                    <div className="d-flex align-items-center">
                                      <img
                                        src={
                                          "https://img.themesbrand.com/velzon/images/img-4.gif"
                                        }
                                        alt=""
                                        className="avatar-xs rounded object-fit-cover"
                                      />
