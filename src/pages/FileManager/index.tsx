...
const FileManager = () => {
  document.title = "File Manager | Rateena - E-Shop Admin Panel";
  ...
  const { folders, files } = useSelector(selectLayoutProperties);
                          ...
                          <CardBody>
                            <div className="d-flex mb-1">
                              ...
                              <UncontrolledDropdown>
                                <DropdownToggle
                                  tag="button"
                                  className="btn btn-ghost-primary btn-icon btn-sm dropdown material-shadow-none"
                                >
          ...
          >
            ...
            {!isEdit && (
              <div className="mb-4">
                <Row>
                  <Col>
                    <label htmlFor="files-input" className="form-label">
                      Files
                    </label>
                    <Input
                      type="text"
