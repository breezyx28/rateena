...
const UiModals = () => {
  ...
  const [modal_animationRight, setmodal_animationRight] =
    useState<boolean>(false);
  function tog_animationRight() {
    setmodal_animationRight(!modal_animationRight);
  }

  const [modal_animationLeft, setmodal_animationLeft] =
    useState<boolean>(false);
  ...
  const [modal_positionTopRight, setmodal_positionTopRight] =
    useState<boolean>(false);
  function tog_positionTopRight() {
    setmodal_positionTopRight(!modal_positionTopRight);
  }

  const [modal_positionBottom, setmodal_positionBottom] =
    useState<boolean>(false);
  ...
  document.title = "Modals | Rateena - E-Shop Admin Panel";
                  ...
                  <div className="live-preview">
                    <div>
                      <div className="hstack flex-wrap gap-2">
                        ...
                        {/* 
                                                // <!-- Extra Large modal --> */}
                        <Button color="info" onClick={() => tog_xlarge()}>
                          Extra large Modal
                        </Button>

                        {/* 
                                                // <!-- Large modal --> */}
                        <Button color="success" onClick={() => tog_large()}>
                          Large Modal
                        </Button>

                        {/* 
                                                // <!-- Small modal --> */}
                        <Button color="danger" onClick={() => tog_small()}>
                          Small Modal
                        </Button>
                      </div>
                    </div>
        ...
        <ModalBody className="text-center p-5">
          ...
          <div className="mt-4 pt-3">
            ...
            <div className="hstack gap-2 justify-content-center">
              ...
              <Button color="light" onClick={() => tog_togSecond()}>
                Close
              </Button>
            </div>
          </div>
      ...
      >
        ...
        <ModalBody>
          ...
          <p className="text-muted">
            ...
            <Link
              to="#"
              className="tooltip-test text-decoration-underline fw-medium material-shadow-none"
