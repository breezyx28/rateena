...
const UiUtilities = () => {
  document.title = "Utilities | Rateena - E-Shop Admin Panel";
  return (
    <React.Fragment>
      <UiContent />
                      ...
                      <div>
                        <div className="d-flex align-items-start flex-wrap gap-4">
                          <div className="text-center">
                            <img
                              src={avatar2}
                              className="avatar-md  material-shadow rounded"
                              alt="rounded"
                            />
                            <p>
                              <code>.rounded</code>
                          ...
                          <div className="text-center">
                            <img
                              src={avatar2}
                              className="avatar-md  material-shadow rounded-top"
                              alt="rounded-top"
                            />
                            <p>
                          ...
                          <div className="text-center">
                            <img
                              src={avatar2}
                              className="avatar-md  material-shadow rounded-end"
                              alt="rounded-end"
                            />
                            <p>
                          ...
                          <div className="text-center">
                            <img
                              src={avatar2}
                              className="avatar-md  material-shadow rounded-bottom"
                              alt="rounded-bottom"
                            />
                            <p>
                          ...
                          <div className="text-center">
                            <img
                              src={avatar2}
                              className="avatar-md  material-shadow rounded-start"
                              alt="rounded-start"
                            />
                            <p>
                          ...
                          <div className="text-center">
                            <img
                              src={avatar2}
                              className="avatar-md  material-shadow rounded-circle"
                              alt="rounded-circle"
                            />
                            <p>
                          ...
                          <div className="text-center">
                            <img
                              src={img2}
                              className="avatar-md  material-shadow w-auto rounded-pill"
                              alt="rounded-pill"
                            />
                            <p>
                      ...
                      <div>
                        ...
                        <div className="d-flex align-items-start flex-wrap gap-4">
                          <div className="text-center">
                            <img
                              src={avatar1}
                              className="avatar-md material-shadow rounded-0"
                              alt="rounded-0"
                            />
                            <p>
                              <code>.rounded-0</code>
                          ...
                          <div className="text-center">
                            <img
                              src={avatar1}
                              className="avatar-md material-shadow rounded-1"
                              alt="rounded-1"
                            />
                            <p>
                              <code>.rounded-1</code>
                          ...
                          <div className="text-center">
                            <img
                              src={avatar1}
                              className="avatar-md material-shadow rounded-2"
                              alt="rounded-2"
                            />
                            <p>
                              <code>.rounded-2</code>
                          ...
                          <div className="text-center">
                            <img
                              src={avatar1}
                              className="avatar-md material-shadow rounded-3"
                              alt="rounded-3"
                            />
                            <p>
                              <code>.rounded-3</code>
                          ...
                          <div className="text-center">
                            <img
                              src={avatar1}
                              className="avatar-md material-shadow rounded-4"
                              alt="rounded-4"
                            />
                            <p>
                              <code>.rounded-4</code>
                          ...
                          <div className="text-center">
                            <img
                              src={avatar1}
                              className="avatar-md material-shadow rounded-5"
                              alt="rounded-5"
                            />
                            <p>
                              <code>.rounded-5</code>
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <div className="vstack gap-3">
                      <div className="bg-light material-shadow border p-1 px-2">
                        First item
                      </div>
                      <div className="bg-light material-shadow border p-1 px-2">
                        Second item
                    ...
                    <div className="mt-5">
                      ...
                      <div className="vstack gap-2 col-md-5 mx-auto">
                        <Button color="primary" className="material-shadow">
                          Save changes
                        </Button>
                        <Button
                          color="secondary"
                  ...
                  <div className="live-preview">
                    ...
                    <div className="mt-4">
                      ...
                      <div className="hstack gap-3">
                        ...
                        <div className="bg-light material-shadow border p-1 px-2 ms-auto">
                          Second item
                        </div>
                        <div className="bg-light material-shadow border p-1 px-2">
                          Third item
