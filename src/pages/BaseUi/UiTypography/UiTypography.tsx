...
const UiTypography = () => {
  document.title = "Typography | Rateena - E-Shop Admin Panel";
  return (
    <React.Fragment>
      <UiContent />
                    ...
                    <Row>
                      ...
                      <Col sm={6}>
                        <div className="text-muted mt-4 mt-sm-0">
                          ...
                          <div>
                            <h1 className="display-4 text-body fw-medium">
                              Aa
                            </h1>
                          </div>
                          <div>
                  ...
                  <div className="live-preview">
                    <div className="row gy-4">
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-primary rounded material-shadow mb-0">
                      ...
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-secondary rounded material-shadow mb-0">
                          <p className="text-body mb-2">
                      ...
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-success rounded material-shadow mb-0">
                          <p className="text-body mb-2">
                      ...
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-info rounded material-shadow mb-0">
                          <p className="text-body mb-2">
                      ...
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-danger rounded material-shadow mb-0">
                          <p className="text-body mb-2">
                      ...
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-warning rounded material-shadow mb-0">
                          <p className="text-body mb-2">
                      ...
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-dark rounded material-shadow mb-0">
                          <p className="text-body mb-2">
              ...
              <Card>
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <div className="row gy-4">
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-outline blockquote-primary rounded material-shadow mb-0">
                          <p className="text-body mb-2">
                      ...
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-outline blockquote-secondary rounded material-shadow mb-0">
                          <p className="text-body mb-2">
                      ...
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-outline blockquote-success rounded material-shadow mb-0">
                          <p className="text-body mb-2">
                      ...
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-outline blockquote-info rounded material-shadow mb-0">
                          <p className="text-body mb-2">
                      ...
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-outline blockquote-danger rounded material-shadow mb-0">
                          <p className="text-body mb-2">
                      ...
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-outline blockquote-warning rounded material-shadow mb-0">
                          <p className="text-body mb-2">
                      ...
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-outline blockquote-dark rounded material-shadow mb-0">
                          <p className="text-body mb-2">
