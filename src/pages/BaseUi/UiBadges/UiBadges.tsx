...
const UiBadges = () => {
  document.title = "Badges | Rateena - E-Shop Admin Panel";
  return (
    <React.Fragment>
      <UiContent />
          ...
          <Row>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>badge-subtle-</code> class with the
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>rounded-pill bg-*-subtle</code> class with the
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <span className="badge rounded-pill bg-light-subtle text-body">
                        Light
                      </span>
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    <code>bg-*-subtle</code> with below mentioned modifier
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <span className="badge bg-light-subtle badge-border text-body">
                        Light
                      </span>
                    </div>
                  </div>
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <Badge color="light" className="badge-label text-body">
                        {" "}
