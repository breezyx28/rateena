...
const UiButtons = () => {
  document.title = "Buttons | Rateena - E-Shop Admin Panel";
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>btn-subtle-</code> class with the below-mentioned
                    variation to create a button with the soft background.
                  </p>{" "}
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      <button className="btn btn-soft-primary waves-effect waves-light material-shadow-none">
                        {" "}
                        Primary{" "}
                      </button>
                      <button className="btn btn-soft-secondary waves-effect waves-light material-shadow-none">
                        {" "}
                        Secondary{" "}
                      </button>
                      <button className="btn btn-soft-success waves-effect waves-light material-shadow-none">
                        {" "}
                        Success{" "}
                      </button>
                      <button className="btn btn-soft-info waves-effect waves-light material-shadow-none">
                        {" "}
                        Info{" "}
                      </button>
                      <button className="btn btn-soft-warning waves-effect waves-light material-shadow-none">
                        {" "}
                        Warning{" "}
                      </button>
                      <button className="btn btn-soft-danger waves-effect waves-light material-shadow-none">
                        {" "}
                        Danger{" "}
                      </button>
                      <button className="btn btn-soft-dark waves-effect waves-light material-shadow-none">
                        {" "}
                        Dark{" "}
                      </button>
                    </div>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      <Button
                        color="primary"
                        outline
                        className="btn btn-ghost-primary material-shadow-none"
                      >
                        Primary
                      </Button>
                      <Button
                        color="secondary"
                        outline
                        className="btn btn-ghost-secondary material-shadow-none"
                      >
                        Secondary
                      </Button>
                      <Button
                        color="success"
                        outline
                        className="btn btn-ghost-success material-shadow-none"
                      >
                        Success
                      </Button>
                      <Button
                        color="info"
                        outline
                        className="btn btn-ghost-info material-shadow-none"
                      >
                        Info
                      </Button>
                      <Button
                        color="warning"
                        outline
                        className="btn btn-ghost-warning material-shadow-none"
                      >
                        Warning
                      </Button>
                      <Button
                      ...
                      <Button
                        color="dark"
                        outline
                        className="btn btn-ghost-dark material-shadow-none"
                      >
                        Dark
                      </Button>
                    </div>
          ...
          <Row>
            <Col lg={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Bootstrap has a base <code>.btn</code> class that sets up
                    basic styles such as padding and content alignment. By
                    default, <code>.btn</code> controls have a transparent
                    border and background color, and lack any explicit focus and
                    hover styles.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap align-items-center gap-2">
                      <ButtonGroup>
                        <Input
                          type="checkbox"
                          className="btn-check material-shadow-none"
                          id="btncheck1"
                          defaultChecked
                        />
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap align-items-center gap-2">
                      <ButtonGroup size="lg" className="material-shadow">
                        <Button color="primary material-shadow-none">
                          Left
                        </Button>
                        <Button color="primary material-shadow-none">
                          Middle
                      ...
                      <ButtonGroup className="mt-2 material-shadow">
                        <Button color="light material-shadow-none">Left</Button>
                        <Button color="light material-shadow-none">
                          Middle
                        </Button>
                        <Button color="light material-shadow-none">
                          Right
                      ...
                      <ButtonGroup size="sm" className="mt-2 material-shadow">
                        <Button color="secondary material-shadow-none">
                          Left
                        </Button>
                        <Button color="secondary material-shadow-none">
                          Middle
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    action, or into the example below and then press{" "}
                    <kbd>Tab</kbd>.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex gap-3">
                      ...
                      <Link
                        ...
                        className="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2"
                        style={{
                          boxShadow: "0 0 0 .25rem rgba(118, 93, 255, .25)",
                        }}
                      >
                        Custom focus ring
                      </Link>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    <code>.focus-ring-*</code> utilities to modify the helper
                    class defaults. Modify the color with any of our{" "}
                    <Link to="/ui-colors">theme colors</Link>. Note that the
