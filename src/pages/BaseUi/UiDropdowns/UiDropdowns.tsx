...
const UiDropdowns = () => {
  ...
  document.title = "Dropdowns | Rateena - E-Shop Admin Panel";
                    ...
                    <div className="d-flex flex-wrap gap-3">
                      <ButtonGroup className="material-shadow">
                        <UncontrolledDropdown>
                          <DropdownToggle
                            tag="button"
                            className="btn btn-primary material-shadow-none"
                          >
                      ...
                      <ButtonGroup className="material-shadow">
                        <UncontrolledDropdown>
                          <DropdownToggle
                            tag="button"
                            className="btn btn-success material-shadow-none"
                          >
                      ...
                      <ButtonGroup className="material-shadow">
                        <UncontrolledDropdown>
                          <DropdownToggle
                            tag="button"
                            className="btn btn-info material-shadow-none"
                          >
                      ...
                      <ButtonGroup className="material-shadow">
                        <UncontrolledDropdown>
                          <DropdownToggle
                            tag="button"
                            className="btn btn-secondary material-shadow-none"
                          >
                      ...
                      <ButtonGroup className="material-shadow">
                        <UncontrolledDropdown>
                          <DropdownToggle
                            tag="button"
                            className="btn btn-warning material-shadow-none"
                          >
                      ...
                      <ButtonGroup className="material-shadow">
                        <UncontrolledDropdown>
                          <DropdownToggle
                            tag="button"
                            className="btn btn-dark material-shadow-none"
                          >
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-3">
                      ...
                      <ButtonGroup className="material-shadow">
                        <UncontrolledButtonDropdown>
                          <Button color="info" className="material-shadow-none">
                            Info
                          </Button>
                          <DropdownToggle
                            tag="button"
                      ...
                      <ButtonGroup className="material-shadow">
                        <UncontrolledButtonDropdown>
                          <Button color="dark" className="material-shadow-none">
                            Dark
                          </Button>
                          <DropdownToggle
                            tag="button"
                    ...
                    <div className="d-flex flex-wrap gap-3 align-items-center">
                      <ButtonGroup className="material-shadow">
                        <UncontrolledDropdown>
                          <DropdownToggle
                            tag="button"
                            className="btn btn-primary material-shadow-none btn-lg"
                          >
                            Large button{" "}
                            <i className="mdi mdi-chevron-down"></i>
                          </DropdownToggle>
                      ...
                      <ButtonGroup className="material-shadow">
                        <UncontrolledButtonDropdown>
                          ...
                          <DropdownToggle
                            tag="button"
                            className="btn btn-light material-shadow-none btn-lg"
                            split
                          ></DropdownToggle>
                          <DropdownMenu>
                            <DropdownItem>Action</DropdownItem>
                      ...
                      <ButtonGroup className="material-shadow">
                        <UncontrolledDropdown>
                          <DropdownToggle
                            tag="button"
                            className="btn btn-primary material-shadow-none btn-sm"
                          >
                            Small button{" "}
                            <i className="mdi mdi-chevron-down"></i>
                          </DropdownToggle>
                      ...
                      <ButtonGroup className="material-shadow">
                        <UncontrolledButtonDropdown>
                          ...
                          <DropdownToggle
                            tag="button"
                            className="btn btn-light material-shadow-none btn-sm"
                            split
                          ></DropdownToggle>
                          <DropdownMenu>
                            <DropdownItem>Action</DropdownItem>
