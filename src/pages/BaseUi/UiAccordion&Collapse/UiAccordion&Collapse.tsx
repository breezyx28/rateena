...
const UiAccordions = () => {
  ...
  document.title = "Accordions | Rateena - E-Shop Admin Panel";
                    ...
                    >
                      ...
                      <AccordionItem className="material-shadow">
                        ...
                        <AccordionBody accordionId="3">
                          ...
                          texts you will need per month, simply find a plan size
                          that allows you to have this allotment, plus some
                          extra for growth. Don't worry, there are no mistakes
                    ...
                    >
                      <AccordionItem className="material-shadow">
                        ...
                        <AccordionBody accordionId="1">
                          ...
                          force an immediate, pro-rated charge to take place on
                          your account.
                        </AccordionBody>
                      </AccordionItem>
                      <AccordionItem className="material-shadow">
                        ...
                        <AccordionBody accordionId="2">
                          If you had signed up on a free account with Slicktext,
                          then upgraded to a paid plan at a later date, your
                          bill will renew based on the date you had upgraded to
                          a paid plan. All invoices are able to be viewed under
                          your plan options in your SlickText account.
                        </AccordionBody>
                      </AccordionItem>
                      <AccordionItem className="material-shadow">
                        <AccordionHeader targetId="3">
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    ...
                    >
                      ...
                      <AccordionItem className="material-shadow">
                        <AccordionHeader targetId="3">
                          <i className="ri-pen-nib-line me-2"></i> How Do I Set
                          Up the Drip Feature?
                        </AccordionHeader>
                        <AccordionBody accordionId="3">
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <Accordion
                      ...
                      open={openWithoutIcons}
                      toggle={toggleWithoutIcons}
                    >
                      <AccordionItem className="material-shadow">
                        <AccordionHeader targetId="1">
                          <i className="ri-global-line me-2"></i> How Does Age
                    ...
                    >
                      ...
                      <AccordionItem className="material-shadow">
                        ...
                        <AccordionBody accordionId="3">
                          ...
                          until it looks right, and each. next level wes
                          anderson artisan four loko farm-to-table craft beer
                          twee. commodo enim craft beer mlkshk aliquip jean
                          shorts ullamco. omo nostrud organic, assumenda labore
                          aesthetic magna delectus. pposites attract, and that’s
                          a fact.
                        </AccordionBody>
                      </AccordionItem>
                    </Accordion>
                    ...
                    >
                      <AccordionItem className="material-shadow">
                        ...
                        <AccordionBody accordionId="1">
                          ...
                          wolf moon tempor, sunt aliqua nulla assumenda
                          shoreditch et.
                        </AccordionBody>
                      </AccordionItem>
                      <AccordionItem className="material-shadow">
                    ...
                    >
                      <AccordionItem className="material-shadow">
                        ...
                        <AccordionBody accordionId="1">
                          ...
                          with Slicktext. For example, upon cashing out online,
                          a subscriber may submit to have their mobile number to
                          receive marketing messages. The API will pass this
                          information from said software over to Slicktext via
                          API integration.
                          <Accordion
                            className="nesting2-accordion custom-accordionwithicon accordion-border-box mt-3"
                            id="accordionnesting2"
                            open={openNesting1}
                            toggle={toggleNesting1}
                          >
                            <AccordionItem className="material-shadow">
                              <AccordionHeader targetId="1">
                              ...
                              <AccordionBody accordionId="1">
                                ...
                                <Accordion
                                  className="nesting4-accordion custom-accordionwithicon accordion-border-box mt-3"
                                  id="accordionnesting4"
                                  open={openNesting2}
                                  toggle={toggleNesting2}
                                >
                                  <AccordionItem className="material-shadow">
                                    <AccordionHeader targetId="1">
                                    ...
                                    <AccordionBody accordionId="1">
                                      ...
                                      you are opting them out of. If this user
                                      was to text to join again, the initial
                                      text they are met with will be a "welcome
                            ...
                            <AccordionItem className="material-shadow">
                              ...
                              <AccordionBody accordionId="2">
                                ...
                                of. If this user was to text to join again, the
                                initial text they are met with will be a
                                "welcome back" message instead of the auto
                                reply.
                              </AccordionBody>
                            </AccordionItem>
                          </Accordion>
                      ...
                      <AccordionItem className="material-shadow">
                        ...
                        <AccordionBody accordionId="2">
                          Personalization allows you to provide a personal touch
                          to your outbound text marketing campaigns. SlickText
                          uses merge tags as placeholders that are replaced with
                          contact-specific information when a text message is
                          sent. These merge tags may also be known as
                          personalization fields.
                          <Accordion
                            className="nesting3-accordion custom-accordionwithicon accordion-border-box mt-3"
                            id="accordionnesting3"
                            open={openNesting21}
                            toggle={toggleNesting21}
                          >
                            <AccordionItem className="material-shadow mt-2">
                              <AccordionHeader targetId="1">
                      ...
                      <AccordionItem className="material-shadow">
                        ...
                        <AccordionBody accordionId="3">
                          When you run out of messages, you will not be able to
                          send any outbound campaigns. This would include any
                          scheduled messages, drip campaigns, and birthday
                    ...
                    <Row>
                      <Col xxl={6}>
                        <Accordion
                          ...
                          id="accordionFill"
                          open={openFillColored}
                          toggle={toggleFillColored}
                        >
                          <AccordionItem className="material-shadow">
                            <AccordionHeader targetId="1">
                              What are webhooks?
                            ...
                            <AccordionBody accordionId="1">
                              ...
                              interactions that happen with your Slick Text
                              account. Simply provide us with a url where you'd
                              like the data to be sent, choose which events
                              you'd like to be informed of, and click save.
                            </AccordionBody>
                          </AccordionItem>
                          <AccordionItem className="material-shadow">
                            <AccordionHeader targetId="2">
                            ...
                            <AccordionBody accordionId="2">
                              Head over to the Textwords page. Click options on
                              the right hand side, and then click Settings. This
                              will redirect you to your Textword Setting page.
                              Now, go check your url, and the textword ID will
                              be the number after "word=". Too much or too
                      ...
                      <Col xxl={6}>
                        <Accordion
                          ...
                          id="accordionFill2"
                          open={openFillColored1}
                          toggle={toggleFillColored1}
                        >
                          <AccordionItem className="material-shadow">
                            <AccordionHeader targetId="1">
                            ...
                            <AccordionBody accordionId="1">
                              ...
                              farm-to-table craft beer twee. commodo enim craft
                          ...
                          <AccordionItem className="material-shadow">
                            ...
                            <AccordionBody accordionId="2">
                              Consistency is the one thing that can take all of
                              the different elements in your design, and tie
                              them all together and make them work. In an
                              awareness campaign, it is vital for people to
                              begin put 2 and 2 together and begin to recognize
                              your cause. Consistency piques people’s interest.
                            </AccordionBody>
                          </AccordionItem>
                          <AccordionItem className="material-shadow">
                            <AccordionHeader targetId="3">
                            ...
                            <AccordionBody accordionId="3">
                              ...
                              imperdiet nec, imperdiet iaculis aliquam ultrices
                              mauris.
                            </AccordionBody>
                          </AccordionItem>
                        </Accordion>
