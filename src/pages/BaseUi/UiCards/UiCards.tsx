...
const UiCards = () => {
  ...
  document.title = "Cards | Rateena - E-Shop Admin Panel";
                      ...
                      <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                        <li className="list-inline-item">
                          <Link
                            ...
                            to="#"
                            onClick={() => spinner("customer-loader")}
                          >
                      ...
                      <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                        <li className="list-inline-item">
                          <Link
                            className="align-middle"
                            to="#"
                            onClick={() => spinner("growing-reload")}
                          >
                            <i className="mdi mdi-refresh align-middle"></i>
                          </Link>
                        </li>
                  ...
                  <Card>
                    <Row className="g-0">
                      ...
                      <div className="col-md-4">
                        <img
                          className="rounded-end img-fluid h-100 object-fit-cover"
                          src={img4}
                          alt="Card"
                        />
                      </div>
