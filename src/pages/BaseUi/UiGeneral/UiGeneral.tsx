...
const UiGeneral = () => {
  document.title = "General | Rateena - E-Shop Admin Panel";
  return (
    <React.Fragment>
      <UiContent />
                    ...
                    <Row>
                      <Col lg={6}>
                        <div className="mt-4">
                          ...
                          <Pagination
                            size="lg"
                            className="pagination-lg pagination-separated"
                          >
                            <PaginationItem disabled>
                              {" "}
                          ...
                          <Pagination
                            size="sm"
                            className="pagination-sm pagination-separated"
                          >
                            <PaginationItem disabled>
                              {" "}
                              <PaginationLink to="#"> ← </PaginationLink>{" "}
                      ...
                      <Col lg={6}>
                        <div className="mt-4">
                          ...
                          <Pagination
                            size="lg"
                            className="pagination-lg pagination-rounded"
                          >
                            <PaginationItem disabled>
                              {" "}
                              <PaginationLink to="#"> ← </PaginationLink>{" "}
                          ...
                          <Pagination
                            size="sm"
                            className="pagination-sm pagination-rounded"
                          >
                            <PaginationItem disabled>
                              {" "}
                              <PaginationLink to="#"> ← </PaginationLink>{" "}
