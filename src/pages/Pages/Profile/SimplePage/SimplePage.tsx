...
const SimplePage = () => {
  document.title = "Profile | Rateena - E-Shop Admin Panel";
                            ...
                            <div>
                              <div className="d-flex align-items-center py-3">
                                ...
                                <div className="flex-shrink-0 ms-2">
                                  <button
                                    type="button"
                                    className="btn btn-sm btn-outline-success material-shadow-none"
                                  >
                          ...
                          <CardBody>
                            ...
                            <div className="d-flex justify-content-end gap-2 mb-2">
                              <div className="slider-button-prev">
                                <div className="avatar-title fs-18 rounded px-1 material-shadow">
                            ...
                            >
                              <div className="swiper-wrapper">
                                <SwiperSlide>
                                  <Card className="profile-project-card shadow-none profile-project-success mb-0 material-shadow">
                                ...
                                <SwiperSlide>
                                  <Card className="profile-project-card shadow-none profile-project-danger mb-0 material-shadow">
                                    <CardBody className="p-4">
                                      <div className="d-flex">
                                        <div className="flex-grow-1 text-muted overflow-hidden">
                                          <h5 className="fs-14 text-truncate mb-1">
                                ...
                                <SwiperSlide>
                                  <Card className="profile-project-card shadow-none profile-project-info mb-0 material-shadow">
                                    <CardBody className="p-4">
                                      <div className="d-flex">
                                        <div className="flex-grow-1 text-muted overflow-hidden">
                                          <h5 className="fs-14 text-truncate mb-1">
                                ...
                                <SwiperSlide>
                                  <Card className="profile-project-card shadow-none profile-project-warning mb-0 material-shadow">
                                    <CardBody className="p-4">
                                      <div className="d-flex">
                                        <div className="flex-grow-1 text-muted overflow-hidden">
                                          <h5 className="fs-14 text-truncate mb-1">
                        ...
                        <Row>
                          {(projects || []).map((item, key) => (
                            <Col xxl={3} sm={6} key={key}>
                              <Card
                                className={`profile-project-card shadow-none material-shadow profile-project-${item.cardBorderColor}`}
                              >
                                <CardBody className="p-4">
                                  <div className="d-flex">
                                    <div className="flex-grow-1 text-muted overflow-hidden">
