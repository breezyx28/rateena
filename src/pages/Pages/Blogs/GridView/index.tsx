...
const BlogGridView = () => {
  document.title = "Grid View | Rateena - E-Shop Admin Panel";
  ...
  const currentdata = useMemo(
    () => gridData?.slice(indexOfFirst, indexOfLast),
                ...
                <div className="card overflow-hidden blog-grid-card">
                  ...
                  <div className="card-body">
                    <h5 className="card-title">
                      <Link to="/pages-blog-overview" className="text-reset">
                        {item.title}
                      </Link>
                    </h5>
                    <p className="text-muted mb-2">{item.description}</p>
                    <Link
                      to="/pages-blog-overview"
                      className="link link-primary text-decoration-underline link-offset-1"
                    >
                      Read Post <i className="ri-arrow-right-up-line"></i>
                    </Link>
                  </div>
                </div>
              </Col>
