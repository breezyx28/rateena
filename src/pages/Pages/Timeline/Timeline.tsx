...
const Timeline = () => {
  ...
  document.title = "Timeline | Rateena - E-Shop Admin Panel";
              ...
              <div>
                ...
                <div className="timeline">
                  ...
                  <div className="timeline-item left">
                    ...
                    <div className="content">
                      <h5>Rateena admin dashboard templates layout upload</h5>
                      <p className="text-muted">
                  ...
                  <div className="timeline-continue">
                    ...
                    <Row className="timeline-right">
                      ...
                      <Col xs={12}>
                        <div className="timeline-box material-shadow">
                          <div className="timeline-text">
                            <h5>Rateena - Project Discussion</h5>
                            <p className="text-muted mb-0">
