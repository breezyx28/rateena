...
const SearchResults = () => {
  ...
  document.title = "Search Results | Rateena - E-Shop Admin Panel";
                  ...
                  <TabContent activeTab={activeTab} className="text-muted">
                    <TabPane tabId="1">
                      <div className="pb-3">
                        <h5 className="mb-1">
                          <Link to="#">
                            Rateena - Responsive Bootstrap 5 Admin Dashboard
                          </Link>
                        </h5>
                        ...
                        <p className="text-muted mb-2">
                          Rateena admin is super flexible, powerful, clean,
                          ...
                          or update design in your existing project using
                          Rateena it is very quick and easy as it is beautiful,
                                ...
                                <div className="d-sm-flex">
                                  ...
                                  <div className="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                    <ul className="list-inline mb-2">
                                      <li className="list-inline-item">
                                        <span
                                          className={`badge bg-${item.badgeClass}-subtle text-${item.badgeClass} fs-11`}
                                        >
                                          {item.badgeText}
                                        </span>
                                      </li>
