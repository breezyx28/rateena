...
const ColumnCharts = () => {
  document.title = "Column Charts | Rateena - E-Shop Admin Panel";
  return (
    <React.Fragment>
          ...
          <Row>
            <Col lg={6}>
              <Card>
                ...
                <CardBody>
                  <GroupStacked dataColors='["--vz-success", "--vz-primary","--vz-secondary", "--vz-danger"]' />
                </CardBody>
              </Card>
            </Col>
            <Col lg={6}>
              <Card>
                ...
                <CardBody>
                  <DumbbellChartColors dataColors='["--vz-success", "--vz-primary"]' />
                </CardBody>
              </Card>
            </Col>
          </Row>
