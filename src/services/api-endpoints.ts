...
export const POST_SEND_OTP = "/users/send-otp";
export const POST_VERIFY_OTP = "/users/verify-otp";
export const POST_VERIFY_USER = "/users/verify-user";
...
// Admin Home
export const GET_HOME_DETAILS = "/details/admin/home";
...
// Customer
export const GET_CUSTOMERS_LIST = "/users/admin/users";
export const GET_CUSTOMER = "/customers/{customerId}";
export const POST_CUSTOMER_BLOCK = "/customers/customerId}/block";
export const POST_CUSTOMER_UNBLOCK = "/customers/{customerId}/unblock";
export const POST_CUSTOMER_UPDATE = "/customers/save";
...
export const GET_ADVERTISEMENT = "/advertisements/{advertisementId}";
export const GET_TOGGLE_ADVERTISEMENTS =
  "/advertisements/toggle/showing/{advertisementId}";
export const POST_ADVERTISEMENT_DELETE =
